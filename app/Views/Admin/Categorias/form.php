        ...
        <div class="col-lg-12">
            <section class="content-body p-xl-4">
                {form_open("admin/categorias/salvar")}
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="row gx-3">
                                    ...
                                    {if (!empty($categoria) || !empty(set_value('id')))}
                    ...
                    {if (!empty($id))}
                    <a class="btn btn-primary" href="{$app_url}admin/categorias/show/{$id}" >Voltar</a>
                    {else}
...
<script src="{$app_url}assets/admin/js/categorias/form.js" type="text/javascript"></script>
