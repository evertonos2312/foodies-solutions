    ...
    <div class="card-body">
        <div class="col-lg-12">
            <section class="content-body p-xl-4">
                {form_open("admin/extras/salvar")}
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="row gx-3">
                                    <div class="col-10  mb-3">
                                        <label class="form-label">Nome extra</label>
                                        {if (!empty($extra))}
                                            {$nome = $extra['nome']}
                                        {else}
                                            {$nome = set_value('nome')}
                                    ...
                                    {if (!empty($extra) || !empty(set_value('id')))}
                                    ...
                                    <div class="col-lg-6  mb-3">
                                        ...
                                        {/if}
                                        <input class="form-control money"  autocomplete="off" name="preco" type="text" value="{$preco}">
                                    </div>
                    ...
                    {if (!empty($id))}
                    <a class="btn btn-primary" href="{$app_url}admin/extras/show/{$id}" >Voltar</a>
                    {else}
...
<script src="{$app_url}assets/admin/js/extras/form.js" type="text/javascript"></script>
