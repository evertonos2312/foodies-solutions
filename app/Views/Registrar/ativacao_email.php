        ...
        <td>
            ...
            <table width="600" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                ...
                <tr>
                    <td width="50"></td>
                    <td>
                        <p>Olá, <?php echo strtok($nome," ")?>!</p>
                        <p>Bem vindo á Pizza Planet!</p>
                        <p><a href="<?php echo site_url('registrar/ativar/'.$token)?>" target="_blank">Clique aqui</a> e confirme seu cadastro.</p>
                        <br><br>
