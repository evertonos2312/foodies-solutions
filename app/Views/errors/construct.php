...
<div class="row" style="margin-top:60px">
    <div class="col-sm-12">
        <div class="w-50 mx-auto text-center">
            <img src="<?php echo base_url()?>/assets/admin/images/empty-sectors.svg" width="350" alt="Página não encontrada">
            <h3 class="mt-4">Oops! Página em construção.</h3>
            <p>Volte mais tarde e confira o novo conteúdo.</p>
            <a href="<?php echo base_url()?>" class="btn btn-primary mt-4">Página inicial</a>
        </div>
    </div>
</div>